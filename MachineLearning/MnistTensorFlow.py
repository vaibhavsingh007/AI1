...
# 92% accuracy, from the above simple one-layer SoftMax network, is actually bad.
# Using Multi-layer Convolution Network to improve this dramatically (~99.2%).
# ref: https://www.tensorflow.org/get_started/mnist/pros#load_mnist_data
